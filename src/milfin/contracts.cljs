...
:matic {:milzap {:abistr #js[
    ...
    "function zapInTokenToSingleSidedVault(address _from, uint amount, address _to, address routerAddr, address _vault, address _recipient) external payable"
