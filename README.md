...
* [`src/milfin/`](src/milfin/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/milfin/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `milfin` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/milfin/config.cljs) defaults to `true` in
...
```clj
(ns milfin.example
  (:require [milfin.config :as config])
